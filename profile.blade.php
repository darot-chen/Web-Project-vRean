                ...
                <div class="row  mx-1 d-flex justify-content-center">
                    ...
                    <div class="col-sm">
                        ...
                        <div class="text-dark w-100">
                            <div class="row mb-3">
                                <div class="col-4">
                                    <span class="text-dark">52 Posts</span>
                                </div>
                                <div class="col-4">
                                    <a href="#" class="text-dark text-decoration-none">52 Followers</a>
                                </div>
                                <div class="col-4">
                                    <a href="#" class="text-dark text-decoration-none">52 Following</a>
                                </div>
                            </div>
                        </div>
